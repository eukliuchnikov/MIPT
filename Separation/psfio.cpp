...
void readBonds(FILE* psfFile, PSF* psfData){
	...
	do{
		safe_fgets(buffer, BUF_SIZE, psfFile);
	} while (strstr(buffer, "!NBOND") == NULL && feof(psfFile) == 0);
	pch = strtok(buffer, " ");
...
void readAngles(FILE* psfFile, PSF* psfData){
	...
	do{
		safe_fgets(buffer, BUF_SIZE, psfFile);
	} while (strstr(buffer, "!NTHETA") == NULL && feof(psfFile) == 0);
	pch = strtok(buffer, " ");
...
void readDihedrals(FILE* psfFile, PSF* psfData){
	...
	do{
		safe_fgets(buffer, BUF_SIZE, psfFile);
	} while (strstr(buffer, "!NPHI") == NULL && feof(psfFile) == 0);
	pch = strtok(buffer, " ");
...
void readImpropers(FILE* psfFile, PSF* psfData){
	...
	do{
		safe_fgets(buffer, BUF_SIZE, psfFile);
	} while (strstr(buffer, "!IMNPHI") == NULL && feof(psfFile) == 0);
	pch = strtok(buffer, " ");
...
void readExclusions(FILE* psfFile, PSF* psfData){
	...
	do{
		safe_fgets(buffer, BUF_SIZE, psfFile);
	} while (strstr(buffer, "!NNB") == NULL && feof(psfFile) == 0);
	pch = strtok(buffer, " ");
